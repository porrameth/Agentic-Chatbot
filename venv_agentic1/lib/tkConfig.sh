...
# installed.
TK_PREFIX='/Users/porrameth/CodeProj2/02_Learn/langchain_academy/AgenticChatbot/venv_agentic1'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/porrameth/CodeProj2/02_Learn/langchain_academy/AgenticChatbot/venv_agentic1'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/porrameth/CodeProj2/02_Learn/langchain_academy/AgenticChatbot/venv_agentic1/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/porrameth/CodeProj2/02_Learn/langchain_academy/AgenticChatbot/venv_agentic1/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/porrameth/CodeProj2/02_Learn/langchain_academy/AgenticChatbot/venv_agentic1/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/porrameth/CodeProj2/02_Learn/langchain_academy/AgenticChatbot/venv_agentic1/lib/libtkstub8.6.a'
