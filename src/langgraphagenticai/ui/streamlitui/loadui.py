...
class LoadStreamlitUI:
    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if self.user_controls["selected_usecase"] =="Chatbot with Web" or self.user_controls["selected_usecase"] =="AI News" or self.user_controls["selected_usecase"] == "Brew Guide":
